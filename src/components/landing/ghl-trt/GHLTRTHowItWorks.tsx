const steps = [
  ...
  },
  {
    num: "02",
    title: "Testing",
    desc: "Get your testosterone levels checked right here in our center. No waiting, no separate appointments. Results before you leave.",
  },
  {
    num: "03",
    title: "Treatment",
    desc: "Start your personalized TRT plan designed specifically for your body and your lifestyle. We keep you dialed in.",
  },
];

const GHLTRTHowItWorks = () => {
  const scrollToForm = () => {
  ...
  return (
    <section className="bg-white py-12 md:py-20">
      <div className="max-w-[1170px] mx-auto px-4">
        ...
        {/* CRO-10: bridge copy */}
        <p className="text-[15px] font-medium text-[#666] mt-6 mb-4 text-center">
          That's it. No hoops. No waiting. Just results.
        </p>
...
export default GHLTRTHowItWorks;
