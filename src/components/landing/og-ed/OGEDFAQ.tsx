...
export const OGEDFAQ = () => (
  <UnifiedFAQ
    ...
    faqs={[
      ...
      { question: "Do I need a referral?", answer: "No. You can book directly with us. No referral from your primary care doctor needed. No prior labs required." },
    ]}
    showContactCTA
    defaultOpenIndex={0}
  />
