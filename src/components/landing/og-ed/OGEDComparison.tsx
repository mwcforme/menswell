...
export const OGEDComparison = () => {
  const features = [
    ...
    { feature: "Privacy", online: "Digital trail, shared data", mwc: "Private clinic, HIPAA-secured" },
  ...
  return (
    <section id="why-mwc" style={{ background: "#ffffff", padding: "clamp(48px, 8vw, 96px) 0" }}>
      <div className="max-w-[1000px] mx-auto px-6">
        ...
        <div className="rounded-xl overflow-hidden mb-12" style={{ background: "#f8f9fa" }}>
          ...
          <div className="hidden md:grid" style={{ gridTemplateColumns: "2fr 1fr 1fr" }}>
            ...
            <div className="p-5 text-center text-base font-bold" style={{ color: "#888888", borderLeft: "1px solid rgba(0,0,0,0.06)" }}>Online ED Services</div>
            ...
            <div key={i}>
              ...
              <div className="md:hidden p-4" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                ...
                <div className="flex items-center gap-2">
                  <Check size={14} style={{ color: "#28a745", flexShrink: 0 }} />
                  <span className="text-[13px] font-medium" style={{ color: "#003366" }}>{item.mwc}</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center">
          ...
          >
            Get Real Treatment from Real Doctors
          </button>
        </div>
      </div>
    </section>
