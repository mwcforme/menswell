...
export const OGEDTestimonials = () => {
  const testimonials = [
    ...
    { name: "David K.", location: "Virginia Beach, VA", text: "Completely confidential and professional. The physician spent over 30 minutes with me, explained everything clearly, and gave me options I didn't even know existed. Results in the first week." },
  ];
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-5 py-3 rounded-lg" style={{ background: "#ffffff", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
            ...
            <span className="text-sm font-medium" style={{ color: "#555555" }}>4.9 ★ on Google · 500+ reviews</span>
          </div>
        </div>
