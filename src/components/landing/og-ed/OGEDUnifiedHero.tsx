        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className="text-white">
            <p className="text-sm font-semibold uppercase tracking-widest mb-4" style={{ color: "rgba(255,255,255,0.6)" }}>
              Erectile Dysfunction Treatment. Physician-Run. Virginia Centers.
            </p>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight mb-6">
              It's Not in Your Head. And You Don't Need Another App.
            </h1>
            <p className="text-base md:text-lg leading-relaxed mb-8" style={{ color: "rgba(255,255,255,0.8)" }}>
              A licensed physician finds the cause, builds your plan, and monitors your progress at one of our 3 Virginia centers. No apps. No subscriptions. No guesswork.
            </p>
            <button
