  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.dispatchEvent(
      new CustomEvent("lp_ed_form_submit", {
        detail: { name, phone, location, source: "lp-ed", service: "ed", form_location: formId },
      })
    );
    ...
    >
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        >
          ...
          />
          <span>
            I consent to receive SMS/text messages from Men's Wellness Centers. Message & data rates
