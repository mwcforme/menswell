  ...
  <section className="py-10 md:py-16" style={{ background: "#000033" }}>
    <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
      <div className="order-2 md:order-1">
        ...
        <h2 className="font-bold uppercase" style={{ fontFamily: "Oswald, sans-serif", fontSize: "clamp(28px, 4vw, 40px)", color: "#FFFFFF", fontWeight: 700, lineHeight: 1.1 }}>
        ...
        <p className="text-base mt-4 leading-[1.7]" style={{ color: "rgba(255,255,255,0.85)", fontFamily: "Inter, sans-serif", fontSize: 16 }}>
          You see the same Virginia physician at the same center. Labs run on-site. Treatment options that go beyond the basics: TriMix and PT-141 in addition to oral medications, when they fit your case.
        </p>
        ...
        <p className="mt-3 text-xs" style={{ color: "rgba(255,255,255,0.55)", fontFamily: "Inter, sans-serif" }}>
          100% confidential. Individual results vary.
        </p>
      </div>
