...
export const TRT2FAQ = () => (
  <UnifiedFAQ
    ...
    faqs={[
      ...
      { question: "How quickly will I see results?", answer: "Most men notice improved energy and mood within 2-4 weeks. Full results, including body composition and libido improvements, typically develop over 3-6 months." },
