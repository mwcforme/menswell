...
export const TRTv2ProblemAgitation = () => {
  const problems = [
    ...
    { icon: TrendingDown, title: "Low Libido", description: "Your drive isn't what it used to be, in or out of the bedroom." },
  ...
  return (
    <section id="problem-agitation" style={{ background: "#EBEAE8", padding: "clamp(48px, 8vw, 96px) 0" }}>
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
          {problems.map((p, i) => (
            ...
            >
              <p.icon size={28} style={{ color: "#000033", marginBottom: 16 }} />
              <h3 className="text-lg font-semibold mb-2" style={{ color: "#000033" }}>{p.title}</h3>
