    ...
    <section id="final-cta" className="py-14 md:py-20" style={{ background: "#000033" }}>
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center">
          <h2 className="font-bold uppercase" style={{ fontFamily: "Oswald, sans-serif", fontSize: "clamp(28px, 4vw, 40px)", color: "#FFFFFF", fontWeight: 700 }}>
            {headline}
          </h2>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div className="order-1 md:order-2">
            <div className="mx-auto rounded-2xl p-8" style={{ background: "#FFFFFF", maxWidth: 480, boxShadow: "0 8px 40px rgba(0,0,0,0.30)" }}>
              <h3 className="font-bold uppercase text-center mb-6" style={{ fontFamily: "Oswald, sans-serif", fontSize: "clamp(20px, 3vw, 24px)", color: "#000033", fontWeight: 700 }}>
                {cardTitle}
              </h3>
              ...
              <p className="text-center text-sm mt-3">
                <a href="tel:8663444955" className="font-bold transition-colors duration-200" style={{ color: "#000033", fontFamily: "Inter, sans-serif" }}>
