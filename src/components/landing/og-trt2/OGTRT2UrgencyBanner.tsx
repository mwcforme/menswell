export const OGTRT2UrgencyBanner = () => {
  const scrollToForm = () => {
  ...
  return (
    <section style={{ background: "#004883", color: "white", padding: "clamp(32px, 5vw, 48px) 0", textAlign: "center" }}>
      <div className="max-w-[800px] mx-auto px-6">
        <h2 className="text-2xl md:text-3xl font-bold leading-tight mb-3">Testosterone Testing This Month</h2>
        <p className="text-base mb-6" style={{ color: "rgba(255,255,255,0.9)" }}>Appointments available at all 3 Virginia locations. Limited appointment availability.</p>
        ...
        >Book My Testosterone Test Today</button>
      </div>
    </section>
  );
};