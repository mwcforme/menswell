...
export const OGTRT2Comparison = () => {
  const features = [
    { feature: "Care model", online: "Telehealth only", mwc: "Face-to-face consultations" },
    { feature: "Lab work", online: "Mail-in kits, wait days", mwc: "Same-day, in-clinic results" },
    ...
    { feature: "Providers", online: "Unknown telehealth docs", mwc: "State-licensed medical providers" },
  ];
    ...
    <section id="comparison" style={{ background: "#ffffff", padding: "clamp(48px, 8vw, 96px) 0" }}>
      <div className="max-w-[1000px] mx-auto px-6">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold leading-tight" style={{ color: "#003366" }}>Why Virginia Men Choose MWC Over Online TRT Mills</h2>
        </div>
            ...
            <div key={i}>
              <div className="hidden md:grid" style={{ gridTemplateColumns: "2fr 1fr 1fr", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                ...
                <div className="p-4 px-5 flex items-center justify-center gap-2" style={{ background: "rgba(0,72,131,0.03)", borderLeft: "1px solid rgba(0,0,0,0.06)" }}>
                  ...
                  <span className="text-[13px] font-medium text-center" style={{ color: "#003366" }}>{item.mwc}</span>
                </div>
              </div>
        ...
        <div className="text-center">
          ...
          >Experience the MWC Difference</button>
        </div>
      </div>
    </section>
  );
