...
export const OGTRT2Testimonials = () => {
  const testimonials = [
    ...
    <section id="testimonials" style={{ background: "#f8f9fa", padding: "clamp(48px, 8vw, 96px) 0" }}>
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold leading-tight" style={{ color: "#003366" }}>Real Members. Real Results.</h2>
        </div>
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-5 py-3 rounded-lg" style={{ background: "#ffffff", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
            ...
            <span className="text-sm font-medium" style={{ color: "#555555" }}>5.0 Rating on Google Reviews</span>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          >Join 10,000+ Men Who Trust MWC</button>
        </div>
      </div>
    </section>
  );
