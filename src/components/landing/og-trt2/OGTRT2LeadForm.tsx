...
export const OGTRT2LeadForm = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.dispatchEvent(
      new CustomEvent("lp_trt2_form_submit", {
        detail: { name, phone, location, source: "og-lp-trt2", service: "trt", form_location: formId },
      })
    );
    ...
    const params = new URLSearchParams({ name, phone, location, source: "og-lp-trt2", service: "trt" });
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="mb-3.5">
          ...
          <input type="tel" placeholder="(555) 123-4567" value={phone} onChange={(e) => setPhone(formatPhone(e.target.value))} autoComplete="tel" className={inputClasses}
            ...
            onFocus={(e) => { e.currentTarget.style.borderColor = "#004883"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(0,72,131,0.08)"; }}
            onBlur={(e) => {
              e.currentTarget.style.borderColor = "#dee2e6"; e.currentTarget.style.boxShadow = "none";
        ...
        <div className="text-center mt-3 text-[12px] flex flex-col gap-1 items-center" style={{ color: "#6c757d" }}>
          <span className="inline-flex items-center gap-1"><MessageCircle size={14} /> We'll text you to confirm within 1 hour. No spam, ever.</span>
