const steps = [
  {
    ...
    body: "Call or schedule online. Choose Richmond, Newport News, or Virginia Beach. Appointments are often available.",
  },
  {
    num: "02",
    title: "Find the Cause",
    body: "Your physician runs labs and reviews your health history to identify what is actually causing the issue. Not a guess. A diagnosis.",
  },
  {
    num: "03",
    title: "Get What Works",
    body: "Based on your results, your physician prescribes treatment tailored to you. Oral medications, injectables, or combination therapy. Dispensed on-site, that day.",
  },
];

export const EDUnifiedHowItWorks = () => {
  return (
    <section style={{ background: "#F5F5F3" }} className="py-16 md:py-20">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <p className="text-center text-base mb-12 max-w-2xl mx-auto" style={{ color: "#4A4A4A" }}>
          Most men complete their evaluation in a single 60-minute visit.
        </p>
